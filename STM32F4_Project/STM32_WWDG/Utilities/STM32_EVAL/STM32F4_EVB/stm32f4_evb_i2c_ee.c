/**
  ...
  *          performed in sEE_LowLevel_Init() function declared in stm32f4_evb.c
  *          file.
...
/** @addtogroup STM32F4_EVB_I2C_EE
  * @brief      This file includes the I2C EEPROM driver of STM32-EVAL boards.
  * @{
  */

/** @defgroup STM32F4_EVB_I2C_EE_Private_Types
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_I2C_EE_Private_Defines
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_I2C_EE_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_I2C_EE_Private_Variables
  * @{
  */
...
/** @defgroup STM32F4_EVB_I2C_EE_Private_Function_Prototypes
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_I2C_EE_Private_Functions
  * @{
  */
...
void sEE_Init(void)
{
	...
	/*!< depending on the sEE Address selected in the stm32f4_evb_i2c_ee.h file */
	...
	else/* More than one Byte Master Reception procedure (DMA) -----------------*/
	{
		...
		while ((*NumByteToRead))
		{
			if (*NumByteToRead == 1) // n-1 byte
			{
				...
				*(pBuffer + i) = I2C_ReceiveData(sEE_I2C);
				(*NumByteToRead)--;
				i++;
			}
...
uint32_t sEE_WritePage(uint8_t* pBuffer, uint16_t WriteAddr, uint8_t* NumByteToWrite)
{
  ...
  /* Set the pointer to the Number of data to be written. This pointer will be used
	...
	for (i = 0; i < *sEEDataWritePointer; i++)
	{

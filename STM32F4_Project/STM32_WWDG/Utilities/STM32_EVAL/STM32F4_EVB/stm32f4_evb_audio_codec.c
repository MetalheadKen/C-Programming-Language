...
--------------------------
   ...
   - Configure the options in file stm32f4_evb_audio_codec.h in the section CONFIGURATION.
   ...
   - For each mode, you may need to implement the relative callback functions into your code.
      ...
      the stm32f4_evb_audio_codec.h file. (refer to the example for more details on the callbacks implementations)
   ...
   - The driver API and the callback functions are at the end of the stm32f4_evb_audio_codec.h file.


 Driver architecture:
 --------------------
 This driver is composed of three main layers:
   o High Audio Layer: consists of the function API exported in the stm32f4_evb_audio_codec.h file
   ...
   o Codec Control layer: consists of the functions API controlling the audio codec (CS43L22) and
     included as local functions in file stm32f4_evb_audio_codec.c (Codec_Init(), Codec_Play() ...)
   o Media Access Layer (MAL): which consists of functions allowing to access the media containing/
     providing the audio file/stream. These functions are also included as local functions into
     the stm32f4_evb_audio_codec.c file (Audio_MAL_Init(), Audio_MAL_Play() ...)
...
/** @addtogroup STM32F4_EVB_AUDIO_CODEC
  * @brief       This file includes the low layer driver for CS43L22 Audio Codec
  *              available on STM32F4-EVB evaluation board.
  * @{
  */

/** @defgroup STM32F4_EVB_AUDIO_CODEC_Private_Types
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_AUDIO_CODEC_Private_Defines
  * @{
  */
...
/** @defgroup STM32F4_EVB_AUDIO_CODEC_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_AUDIO_CODEC_Private_Variables
  * @{
  */
...
/** @defgroup STM32F4_EVB_AUDIO_CODEC_Private_Function_Prototypes
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_AUDIO_CODEC_Private_Functions
  * @{
  */
...
//	Codec_WriteRegister(0x1D, 0xE6);
//	Codec_WriteRegister(0x1C, 0x7F);
...
static void Codec_GPIO_Init(void)
{
	...
	/* If the I2C peripheral is already enabled, don't reconfigure it */
	if ((CODEC_I2C->CR1 & I2C_CR1_PE) != I2C_CR1_PE)
	{

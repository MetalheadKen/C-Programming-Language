...
/** @defgroup STM32F4_EVB_LOW_LEVEL
  * @brief This file provides firmware functions to manage Leds, push-buttons,
  *        COM ports, SD card on SDIO and serial EEPROM (sEE) available on
  *        STM32F4_EVB evaluation board from STMicroelectronics.
  * @{
  */

/** @defgroup STM32F4_EVB_LOW_LEVEL_Private_TypesDefinitions
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_LOW_LEVEL_Private_Defines
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_LOW_LEVEL_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_LOW_LEVEL_Private_Variables
  * @{
  */
...
/** @defgroup STM32F4_EVB_LOW_LEVEL_Private_FunctionPrototypes
  * @{
  */
...
/** @defgroup STM32F4_EVB_LOW_LEVEL_Private_Functions
  * @{
  */

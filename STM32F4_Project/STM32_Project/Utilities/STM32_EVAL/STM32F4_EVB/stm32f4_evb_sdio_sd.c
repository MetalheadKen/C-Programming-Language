/**
  ******************************************************************************
  * @file    stm32f4_evb_sdio_sd.c
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    29-March-2013
  * @brief   This file provides a set of functions needed to manage the SDIO SD 
  *          Card memory mounted on STM32F4-EVB evaluation board.
  *
  *  @verbatim
  *
  *          ===================================================================
  ...
  *          GPIO) are defined in stm32f4_evb.h file, and the initialization is 
  *          performed in SD_LowLevel_Init() function declared in stm32f4_evb.c 
  *          file.
  ...
  *                  "SDIO_INIT_CLK_DIV" define inside the stm32f4_evb.h file. 
  ...
  *                  define inside the stm32f4_evb.h file.
  *                  The SD Card frequency (SDIO_CK) is computed as follows:
  *
  *                     +---------------------------------------------+
  *                     | SDIO_CK = SDIOCLK / (SDIO_INIT_CLK_DIV + 2) |
  ...
  *             "SD_DMA_MODE" or "SD_POLLING_MODE" inside the stm32f4_evb_sdio_sd.h
...
/** @addtogroup STM32F4_EVB_SDIO_SD
  * @brief      This file provides all the SD Card driver firmware functions.
  * @{
  */ 

/** @defgroup STM32F4_EVB_SDIO_SD_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F4_EVB_SDIO_SD_Private_Defines
  * @{
  */ 
...
/** @defgroup STM32F4_EVB_SDIO_SD_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F4_EVB_SDIO_SD_Private_Variables
  * @{
  */
...
/** @defgroup STM32F4_EVB_SDIO_SD_Private_Function_Prototypes
  * @{
  */
...
/** @defgroup STM32F4_EVB_SDIO_SD_Private_Functions
  * @{
  */  
...
SD_Error SD_Init(void)
{
	...
	if (GPIO_ReadInputDataBit(SD_DETECT_GPIO_PORT, SD_DETECT_PIN) == SET)
	{
		LCD_DisplayStringLine(LCD_LINE_15, (uint8_t *)" NO CARD");
		return SD_ERROR;
	}
	...
	LCD_DisplayStringLine(LCD_LINE_15, (uint8_t *)" CARD INITIALIZE OK");

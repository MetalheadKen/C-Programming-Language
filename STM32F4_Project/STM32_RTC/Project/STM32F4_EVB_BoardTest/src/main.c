...
void RTC_TimeShow(void)
{
  ...
  sprintf((char*)aShowTime,"%0.2d:%0.2d:%0.2d",RTC_TimeStructure.RTC_Hours, RTC_TimeStructure.RTC_Minutes, RTC_TimeStructure.RTC_Seconds);
	...
	uint8_t hour[] = {((RTC_TimeStructure.RTC_Hours / 10) + 0x30), ((RTC_TimeStructure.RTC_Hours % 10) + 0x30), '\0'};
	uint8_t min[] = {((RTC_TimeStructure.RTC_Minutes / 10) + 0x30), ((RTC_TimeStructure.RTC_Minutes % 10) + 0x30), '\0'};
	uint8_t sec[] = {((RTC_TimeStructure.RTC_Seconds / 10) + 0x30), ((RTC_TimeStructure.RTC_Seconds % 10) + 0x30), '\0'};
	
  LCD_Clear(Black);
  LCD_SetBackColor(Black);
  LCD_SetTextColor(White);

  LCD_DisplayStringLine(Line0, hour);
	LCD_DisplayStringLine(Line1, min);
  LCD_DisplayStringLine(Line2, sec);
}
...
void RTC_AlarmShow(void)
{
  ...
  sprintf((char*)showalarm,"%0.2d:%0.2d:%0.2d", RTC_AlarmStructure.RTC_AlarmTime.RTC_Hours, RTC_AlarmStructure.RTC_AlarmTime.RTC_Minutes, RTC_AlarmStructure.RTC_AlarmTime.RTC_Seconds);
	/*
  LCD_DisplayStringLine(Line3, (uint8_t*)(RTC_AlarmStructure.RTC_AlarmTime.RTC_Hours + 0x31));
  LCD_DisplayStringLine(Line4, (uint8_t*)(RTC_AlarmStructure.RTC_AlarmTime.RTC_Minutes + 0x31));
  LCD_DisplayStringLine(Line5, (uint8_t*)(RTC_AlarmStructure.RTC_AlarmTime.RTC_Seconds + 0x31));*/
}
